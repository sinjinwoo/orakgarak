...
public class CustomRestAdvice {
    ...
    public ResponseEntity<Map<String, Object>> handleRecordNotFoundException(
    ...
    public ResponseEntity<Map<String, Object>> handleRecordPermissionDeniedException(
            RecordPermissionDeniedException e) {
        log.warn("Record permission denied: {}", e.getMessage());
        return createErrorResponse(HttpStatus.FORBIDDEN, "RECORD_PERMISSION_DENIED",
                e.getMessage());
    }

    @ExceptionHandler(UploadNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleUploadNotFoundException(
    ...
    public ResponseEntity<Map<String, Object>> handleAudioConversionException(
            AudioConversionException e) {
        log.error("Audio conversion error: {}", e.getMessage(), e);
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "AUDIO_CONVERSION_ERROR",
                e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleS3UploadException(S3UploadException e) {
        ...
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "S3_UPLOAD_ERROR",
                e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleS3DeleteException(S3DeleteException e) {
        ...
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "S3_DELETE_ERROR",
                e.getMessage());
    }

    @ExceptionHandler(InvalidFileNameException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidFileNameException(
    ...
    public ResponseEntity<Map<String, Object>> handlePresignedUrlException(
            PresignedUrlException e) {
        log.error("Presigned URL error: {}", e.getMessage(), e);
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "PRESIGNED_URL_ERROR",
                e.getMessage());
    }

    @ExceptionHandler(ThumbnailCreationException.class)
    public ResponseEntity<Map<String, Object>> handleThumbnailCreationException(
            ThumbnailCreationException e) {
        log.error("Thumbnail creation error: {}", e.getMessage(), e);
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "THUMBNAIL_CREATION_ERROR",
                e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidRefreshTokenException(
        ...
        return createErrorResponse(HttpStatus.UNAUTHORIZED, "INVALID_REFRESH_TOKEN",
                e.getMessage());
    }

    @ExceptionHandler(MissingRefreshTokenException.class)
    public ResponseEntity<Map<String, Object>> handleMissingRefreshTokenException(
    ...
    public ResponseEntity<Map<String, Object>> handleRecordOperationException(
            RecordOperationException e) {
        log.error("Record operation error: {}", e.getMessage(), e);
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "RECORD_OPERATION_ERROR",
                e.getMessage());
    }
    ...
    @ExceptionHandler(com.ssafy.lab.orak.profile.exception.ProfileNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleProfileNotFoundException(
            com.ssafy.lab.orak.profile.exception.ProfileNotFoundException e) {
        log.error("Profile not found: {}", e.getMessage());
        return createErrorResponse(HttpStatus.NOT_FOUND, "PROFILE_NOT_FOUND", e.getMessage());
    }
