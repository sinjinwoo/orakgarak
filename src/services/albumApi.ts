...
export const albumService = {
  ...
  createAlbum: async (albumData: CreateAlbumRequest): Promise<Album> => {
    try {
      const response: AxiosResponse<Album> = await albumApi.post('/albums', albumData);
  ...
  getAlbums: async (params?: AlbumQueryParams): Promise<{ content: Album[]; totalElements: number; totalPages: number; size: number; number: number }> => {
    try {
  ...
  getAlbumById: async (albumId: number): Promise<Album> => {
    try {
      const response: AxiosResponse<Album> = await albumApi.get(`/albums/${albumId}`);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  updateAlbum: async (albumId: number, albumData: UpdateAlbumRequest): Promise<Album> => {
    try {
      const response: AxiosResponse<Album> = await albumApi.put(`/albums/${albumId}`, albumData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  getAlbumTracks: async (albumId: number): Promise<AlbumTracksResponse> => {
    try {
      const response: AxiosResponse<AlbumTracksResponse> = await albumApi.get(`/albums/${albumId}/tracks`);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  addTrack: async (albumId: number, trackData: AddTrackRequest): Promise<AlbumTrack> => {
    try {
      const response: AxiosResponse<AlbumTrack> = await albumApi.post(`/albums/${albumId}/tracks`, trackData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  addTracks: async (albumId: number, tracksData: BulkAddTracksRequest): Promise<AlbumTrack[]> => {
    try {
      const response: AxiosResponse<AlbumTrack[]> = await albumApi.post(`/albums/${albumId}/tracks/bulk`, tracksData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  reorderTrack: async (albumId: number, reorderData: { fromOrder: number; toOrder: number }): Promise<AlbumTracksResponse> => {
    try {
      const response: AxiosResponse<AlbumTracksResponse> = await albumApi.put(`/albums/${albumId}/tracks/reorder`, reorderData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  // 앨범 커버 관련 API
  uploadCover: async (file: File): Promise<{ uploadId: number; imageUrl: string }> => {
    try {
  ...
  generateCover: async (uploadIds: number[]): Promise<{ uploadId: number; imageUrl: string }> => {
    try {
      const response = await albumApi.post('/albums/covers/generate', { uploadIds });
      return response.data;
    } catch (error) {
      throw error;
    }
